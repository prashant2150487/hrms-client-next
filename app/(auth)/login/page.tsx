        ...
        <div className="w-full max-w-[900px] h-full max-h-[850px] bg-[#FDFDFD] rounded-[32px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] flex border border-white relative z-10 overflow-hidden">
          ...
          <div className="w-[260px] border-r border-[#F0F0F0] p-7 flex flex-col gap-6 bg-white shrink-0">
            <div className="flex items-center gap-3 mb-4 mix-blend-multiply">
              ...
              <span className="text-[22px] font-bold tracking-tight text-dark">HRMS</span>
            </div>
            ...
            <div className="space-y-[8px] pt-4 h-full flex flex-col">
              ...
              <div className="h-11 text-gray-normal hover:bg-gray-50 rounded-[10px] flex items-center px-4 text-[14px] font-medium gap-4 transition-all">
                <span className="text-[20px] opacity-70">🏢</span> All Departments
              </div>
              <div className="h-11 text-gray-normal hover:bg-gray-50 rounded-[10px] flex items-center px-4 text-[14px] font-medium gap-4 transition-all">
          ...
          <div className="flex-1 p-8 bg-[#FAFAFC] overflow-hidden flex flex-col gap-6">
            ...
            <div className="flex justify-between items-start mb-2">
              <div>
                ...
                <p className="text-[13px] text-gray-normal mt-1 font-medium">Good Morning</p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-5">
              <div className="bg-white p-5 rounded-[16px] border border-gray-100 flex flex-col gap-3 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                <div className="flex items-center gap-3 text-[13px] text-gray-normal font-medium">
                  <span className="bg-primary/10 p-1.5 rounded-lg text-primary text-[14px]">👥</span> Total Employee
                </div>
                <div className="flex items-end justify-between mt-1">
                  <span className="text-[32px] font-bold text-dark leading-none">560</span>
                  <span className="text-[10px] text-secondary font-bold bg-secondary/10 px-2 py-1 rounded-[4px] text-green-600 flex items-center gap-1">↑ 12%</span>
                </div>
                <span className="text-[11px] text-gray-400">Update: July 16, 2023</span>
              </div>

              <div className="bg-white p-5 rounded-[16px] border border-gray-100 flex flex-col gap-3 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                <div className="flex items-center gap-3 text-[13px] text-gray-normal font-medium">
                  <span className="bg-primary/10 p-1.5 rounded-lg text-primary text-[14px]">💼</span> Total Applicant
                </div>
                <div className="flex items-end justify-between mt-1">
                  <span className="text-[32px] font-bold text-dark leading-none">1050</span>
                  <span className="text-[10px] text-secondary font-bold bg-secondary/10 px-2 py-1 rounded-[4px] text-green-600 flex items-center gap-1">↑ 5%</span>
                </div>
                <span className="text-[11px] text-gray-400">Update: July 14, 2023</span>
              </div>

              <div className="bg-white p-5 rounded-[16px] border border-gray-100 flex flex-col gap-3 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                <div className="flex items-center gap-3 text-[13px] text-gray-normal font-medium">
                  <span className="bg-primary/10 p-1.5 rounded-lg text-primary text-[14px]">📅</span> Today Attendance
                </div>
                <div className="flex items-end justify-between mt-1">
                  <span className="text-[32px] font-bold text-dark leading-none">470</span>
                  <span className="text-[10px] font-bold bg-red-500/10 px-2 py-1 rounded-[4px] text-red-500 flex items-center gap-1">↓ 3%</span>
                </div>
                <span className="text-[11px] text-gray-400">Update: July 14, 2023</span>
              </div>
              ...
              <div className="bg-white p-5 rounded-[16px] border border-gray-100 flex flex-col gap-3 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                <div className="flex items-center gap-3 text-[13px] text-gray-normal font-medium">
                  <span className="bg-primary/10 p-1.5 rounded-lg text-primary text-[14px]">📋</span> Total Projects
                </div>
                <div className="flex items-end justify-between mt-1">
                  <span className="text-[32px] font-bold text-dark leading-none">250</span>
                  <span className="text-[10px] text-secondary font-bold bg-secondary/10 px-2 py-1 rounded-[4px] text-green-600 flex items-center gap-1">↑ 12%</span>
                </div>
                <span className="text-[11px] text-gray-400">Update: July 10, 2023</span>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-[16px] border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex-1 flex flex-col">
              <div className="flex justify-between items-center mb-8">
                <h3 className="font-bold text-[16px] text-dark">Attendance Overview</h3>
              ...
              <div className="flex-1 flex items-end justify-between px-2 pt-4 relative">
                ...
                {[
                  ...
                  <div key={i} className="flex flex-col items-center gap-3 w-8 h-full">
                    <div className="w-2.5 h-full flex flex-col justify-end gap-1.5">
                      <div className="w-full bg-[#FF7976] rounded-[4px]" style={{ height: `${bar.h3}%` }}></div>
                      <div className="w-full bg-[#FFB648] rounded-[4px]" style={{ height: `${bar.h2}%` }}></div>
                      <div className="w-full bg-primary rounded-[4px]" style={{ height: `${bar.h1}%` }}></div>
                    </div>
                    <span className="text-[11px] text-gray-normal font-medium">{bar.day}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="w-full max-w-[420px] mx-auto">
          ...
          <div className="flex flex-col mb-10">
            ...
            <div className="flex items-center gap-3 mb-[60px]">
              ...
              <span className="text-[28px] font-bold tracking-tight text-dark">HRMS</span>
            </div>
