          ...
          <div className="container mx-auto px-4 md:px-6 text-center">
            <div className="mx-auto max-w-3xl space-y-8">
              ...
              <p className="mx-auto max-w-2xl text-lg text-gray-600 sm:text-xl leading-relaxed">
                Streamline your workforce management with an intelligent
                platform that puts people first. Onboard, manage, and scale your
                team effortlessly.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                <Link href="/register">
                  <Button
                    size="lg"
                    className="rounded-full h-12 px-8 shadow-lg shadow-blue-600/20 w-full sm:w-auto text-base"
                  >
                    Start for free
                ...
                <Link href="#demo">
                  <Button
                    variant="outline"
                    size="lg"
                    className="rounded-full h-12 px-8 w-full sm:w-auto text-base border-gray-200"
                  >
                    Book a demo
                  </Button>
                </Link>
              ...
              <div className="pt-8 flex items-center justify-center gap-8 text-sm text-gray-500 font-medium">
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-500" /> 14-day
                  free trial
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Powerful tools that automate the busywork so you can focus on
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow group">
                ...
                <p className="text-gray-600">
                  A centralized hub for all employee information, documents, and
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow group">
                ...
                <p className="text-gray-600">
                  Effortless time tracking, leave requests, and automated
                  scheduling for your entire workforce.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow group">
                ...
                <p className="text-gray-600">
                  Set goals, track progress, and conduct continuous performance
        ...
        <section className="py-24 bg-blue-600 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
            ...
            <p className="text-blue-100 text-lg mb-10 max-w-2xl mx-auto">
              Join thousands of companies that use our HRMS to build better
              workplaces and empower their employees.
            </p>
            <Link href="/register">
              <Button
                size="lg"
                variant="secondary"
                className="rounded-full h-14 px-10 text-lg text-blue-600 font-semibold shadow-xl hover:scale-105 transition-transform"
              >
