...
export const Checkbox = ({
    label, size = "md", color = "purple",
    align = "left", checked, defaultChecked = false,
    ...
    return (
        <label onClick={toggle} style={{
            ...
            gap: s.gap, cursor: disabled ? "not-allowed" : "pointer",
            ...
            <span style={boxStyle}>
                {(isChecked || indeterminate) && (
                    <svg width={s.icon} height={s.icon} viewBox="0 0 16 16" fill="none">
                        {indeterminate
                            ? <line x1="3" y1="8" x2="13" y2="8" stroke="white" strokeWidth="2.5" strokeLinecap="round" />
                            : <polyline points="2.5,8.5 6.5,12.5 13.5,4" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        }
                    </svg>
                )}
            </span>
